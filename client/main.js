...
const modes = [
  ...
  { key: "daily", label: "Mode Quotidien (Bientôt !)", enabled: false },
  { key: "duel", label: "Mode Duel (Bientôt !)", enabled: false },
];
...
function renderHome() {
  app.innerHTML = `
    <div class="screen">
      <header class="hero">
        <h1>Splashdle</h1>
        <p class="lede">Devine le champion à partir de son splash art. Choisis un mode pour commencer.</p>
      </header>
  ...
  app.innerHTML = `
    ...
    <div class="screen">
      <header class="hero">
        ...
        <p class="lede">Test du proxy et des données champion/skins.</p>
      </header>
